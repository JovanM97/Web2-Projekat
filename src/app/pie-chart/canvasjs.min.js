/*
 ...
 Copyright 2021 fenopix
  ...
  --------------------- License Information --------------------
 CanvasJS is a commercial product which requires purchase of license. Without a commercial license you can use it for evaluation purposes for upto 30 days. Please refer to the following link for further details. eeDwdouMhrudods
...
16|h[1]<<8|h[2]:0}function ka(h,m,w){return h in m?m[h]:w[h]}function La(h,m,w){if(v&&Za){var s=h.getContext("2d");Ma=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ga=Qa/Ma;h.width=m*ga;h.height=w*ga;Qa!==Ma&&(h.style.width=m+"px",h.style.height=w+"px",s.scale(ga,ga))}else h.width=m,h.height=w}function hb(h){if(!ib){var m=!1,w=!1;

"undefined"===typeof pa.Chart.creditHref?(h.creditHref=X(""),
h.creditText=X("")):(m=h.updateOption("creditText"),w=h.updateOption("creditHref"));
